...
- **Private Reporting**: https://github.com/this-repo/security/advisories
...
**Steps:**
1. Go to: https://github.com/this-repo/security/advisories
...
1. Go to: https://github.com/this-repo/security/dependabot/alerts
2. Review the alert
