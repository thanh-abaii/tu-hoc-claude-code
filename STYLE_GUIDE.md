...
> Conventions and formatting rules for contributing to Tự Học Claude Code. Follow this guide to keep content consistent, professional, and easy to maintain.
...
| **Image assets** | Kebab-case | `pr-slash-command.png`, `tu-hoc-claude-code-logo.svg` |
...
```html
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="resources/logos/tu-hoc-claude-code-logo-dark.svg">
  <img alt="Tự Học Claude Code" src="resources/logos/tu-hoc-claude-code-logo.svg">
</picture>
```
