...
The security of the Tự Học Claude Code project is important to us. This document outlines our security practices and describes how to report security vulnerabilities responsibly.
...
1. Visit: https://github.com/this-repo/security/advisories
...
Past security advisories are available in the [GitHub Security Advisories](https://github.com/this-repo/security/advisories) tab.
...
Thank you for helping keep Tự Học Claude Code secure! 🔒
